...
class Tanpopo_DriverReport {
    ...
    private function get_weekly_summary( $crew_code, $year_month, $monthly_rows ) {
        ...
        // 表示期間 = 前月末日から carry_days 日遡った日〜前月末日
        // -------------------------------------------------------
        if ( $carry_days > 0 ) {
            ...
            $carry_break      = $carry_kousoku - $carry_labor;
